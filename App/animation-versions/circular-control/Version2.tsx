/* 
The knob is only activated when the user drags it specifically, 
dragging elsewhere from the knob itself won't activate it

The controller stops at 100% full rotation, and doesn't overflow to reset to 0
*/
